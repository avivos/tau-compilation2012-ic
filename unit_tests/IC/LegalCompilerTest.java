...
//	@Test
//	public void legalprog_test() {
//		assertTrue(TestUtils.runTestFile(testDir + "legalprog.ic.good", "-debug"));
//	}
	
	@Test
	public void legalprog2_test() {
		assertTrue(TestUtils.runTestFile(testDir + "legalprog2.ic.good", "-debug"));
	}
	
	@Test
	public void example2_test() {
		assertTrue(TestUtils.runTestFile(testDir + "example2.ic.good", "-debug"));
	}
