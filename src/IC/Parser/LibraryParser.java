...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Mar 06 14:12:07 IST 2012
  */
public @SuppressWarnings(value={"all"}) class LibraryParser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\007\000\002\004\004\000\002\004\002\000\002\010\011" +
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\036\000\004\011\006\001\002\000\004\002\040\001" +
    "\002\000\004\002\001\001\002\000\004\012\007\001\002" +
    "\000\004\031\010\001\002\000\006\046\ufffd\052\ufffd\001" +
    "\002\000\006\046\013\052\012\001\002\000\014\007\021" +
    "\012\016\053\015\057\020\062\022\001\002\000\004\002" +
    "\uffff\001\002\000\006\046\ufffe\052\ufffe\001\002\000\004" +
    "\004\ufff9\001\002\000\004\004\ufff7\001\002\000\004\004" +
    "\025\001\002\000\004\004\ufff8\001\002\000\004\004\ufffa" +
    "\001\002\000\006\004\ufffb\027\023\001\002\000\004\061" +
    "\024\001\002\000\004\004\ufff6\001\002\000\004\030\026" +
    "\001\002\000\020\007\021\012\016\013\ufff5\050\ufff5\053" +
    "\015\057\020\062\022\001\002\000\006\013\ufff4\050\ufff4" +
    "\001\002\000\004\004\037\001\002\000\006\013\032\050" +
    "\033\001\002\000\014\007\021\012\016\053\015\057\020" +
    "\062\022\001\002\000\004\051\034\001\002\000\006\046" +
    "\ufffc\052\ufffc\001\002\000\004\004\036\001\002\000\006" +
    "\013\ufff2\050\ufff2\001\002\000\006\013\ufff3\050\ufff3\001" +
  ...
  protected static final short[][] _reduce_table = 
    ...
    "\000\004\004\010\001\001\000\004\010\013\001\001\000" +
    "\004\005\016\001\001\000\002\001\001\000\002\001\001" +
    "\000\002\001\001\000\002\001\001\000\002\001\001\000" +
    "\002\001\001\000\002\001\001\000\002\001\001\000\002" +
    "\001\001\000\002\001\001\000\002\001\001\000\010\005" +
    "\027\006\030\007\026\001\001\000\002\001\001\000\002" +
  ...
  public final java_cup.runtime.Symbol CUP$LibraryParser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$LibraryParser$act_num)
        {
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 15: // formals_list ::= formals COMMA type ID 
            {
              List<Formal> RESULT =null;
		int varsleft = ((java_cup.runtime.Symbol)CUP$LibraryParser$stack.elementAt(CUP$LibraryParser$top-3)).left;
		int varsright = ((java_cup.runtime.Symbol)CUP$LibraryParser$stack.elementAt(CUP$LibraryParser$top-3)).right;
		List<Formal> vars = (List<Formal>)((java_cup.runtime.Symbol) CUP$LibraryParser$stack.elementAt(CUP$LibraryParser$top-3)).value;
	...
	RESULT = vars;
              ...
              CUP$LibraryParser$result = parser.getSymbolFactory().newSymbol("formals_list",5, ((java_cup.runtime.Symbol)CUP$LibraryParser$stack.elementAt(CUP$LibraryParser$top-3)), ((java_cup.runtime.Symbol)CUP$LibraryParser$stack.peek()), RESULT);
            }
          return CUP$LibraryParser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 14: // formals_list ::= type ID 
            {
              List<Formal> RESULT =null;
		int tleft = ((java_cup.runtime.Symbol)CUP$LibraryParser$stack.elementAt(CUP$LibraryParser$top-1)).left;
		int tright = ((java_cup.runtime.Symbol)CUP$LibraryParser$stack.elementAt(CUP$LibraryParser$top-1)).right;
	...
	RESULT.add(var);
              ...
              CUP$LibraryParser$result = parser.getSymbolFactory().newSymbol("formals_list",5, ((java_cup.runtime.Symbol)CUP$LibraryParser$stack.elementAt(CUP$LibraryParser$top-1)), ((java_cup.runtime.Symbol)CUP$LibraryParser$stack.peek()), RESULT);
            }
          return CUP$LibraryParser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 13: // formals ::= formals_list 
            {
              List<Formal> RESULT =null;
	...
	RESULT = new PrimitiveType(nameleft, DataTypes.INT);
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 5: // method ::= STATIC type ID LP formals RP SEMI 
            {
	...
	RESULT = new LibraryMethod(type_name, m_name, f); 
              ...
              CUP$LibraryParser$result = parser.getSymbolFactory().newSymbol("method",6, ((java_cup.runtime.Symbol)CUP$LibraryParser$stack.elementAt(CUP$LibraryParser$top-6)), ((java_cup.runtime.Symbol)CUP$LibraryParser$stack.peek()), RESULT);
            }
          return CUP$LibraryParser$result;
	...
	RESULT = new ArrayList<Method>();
              ...
              CUP$LibraryParser$result = parser.getSymbolFactory().newSymbol("methodDeclList",2, ((java_cup.runtime.Symbol)CUP$LibraryParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$LibraryParser$stack.peek()), RESULT);
            }
          return CUP$LibraryParser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 3: // methodDeclList ::= methodDeclList method 
            {
              List<Method> RESULT =null;
	...
	RESULT.add(m);
              ...
              CUP$LibraryParser$result = parser.getSymbolFactory().newSymbol("methodDeclList",2, ((java_cup.runtime.Symbol)CUP$LibraryParser$stack.elementAt(CUP$LibraryParser$top-1)), ((java_cup.runtime.Symbol)CUP$LibraryParser$stack.peek()), RESULT);
            }
          return CUP$LibraryParser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 2: // classDecl ::= CLASS CLASS_ID LCBR methodDeclList RCBR 
            {
              ICClass RESULT =null;
	...
	RESULT = new ICClass(nameleft, (String)name, new ArrayList<Field>(), dclList);
              ...
              CUP$LibraryParser$result = parser.getSymbolFactory().newSymbol("classDecl",1, ((java_cup.runtime.Symbol)CUP$LibraryParser$stack.elementAt(CUP$LibraryParser$top-4)), ((java_cup.runtime.Symbol)CUP$LibraryParser$stack.peek()), RESULT);
            }
          return CUP$LibraryParser$result;
		...
		ICClass cl = (ICClass)((java_cup.runtime.Symbol) CUP$LibraryParser$stack.peek()).value;
