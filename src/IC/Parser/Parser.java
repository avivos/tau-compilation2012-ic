...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Dec 13 17:02:51 IST 2011
  */
...
public void unrecovered_syntax_error(Symbol s) throws Exception {
	done_parsing();
	Token tok = (Token) s;
	//System.out.println("Line " + tok.getLine()+": Syntax error; unexpected " + tok.id);
	throw new LexicalError("Syntax Error: unexpected token:" + tok.id ,tok.getLine());
}
